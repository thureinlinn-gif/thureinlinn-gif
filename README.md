...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:tl989@drexel.edu)
...
<table style="width:100%; border-collapse: collapse; margin: 20px 0;">
  <tr style="background-color: #f8f9fa; text-align: center; font-weight: bold;">
    <td style="width:33%; padding: 15px; border: 1px solid #ddd;">🤖 AI/ML & Data Science</td>
    <td style="width:33%; padding: 15px; border: 1px solid #ddd;">💻 Software Engineering</td>
    <td style="width:33%; padding: 15px; border: 1px solid #ddd;">🔧 IT Support & Systems</td>
  </tr>
  <tr>
    <td style="padding: 15px; border: 1px solid #ddd; vertical-align: top;">
      • AI/ML Developer<br>• Data Scientist<br>• Machine Learning Engineer<br>• Data Analyst<br>• Research Scientist
    </td>
    <td style="padding: 15px; border: 1px solid #ddd; vertical-align: top;">
      • Full-Stack Developer<br>• Software Engineer<br>• Backend Developer<br>• QA/Test Engineer<br>• Java Developer
    </td>
    <td style="padding: 15px; border: 1px solid #ddd; vertical-align: top;">
      • IT Support Specialist<br>• Systems Administrator<br>• Database Administrator<br>• Technical Support<br>• Digital Production Designer
    </td>
  </tr>
</table>
...
![](https://github-readme-stats.vercel.app/api?username=thureinlinn-gif&theme=react&hide_border=false&include_all_commits=true&count_private=true&hide=issues)
...
I'm a **high-energy, results-driven** Drexel CS student who delivers fast and clean code while being easy to work with.

**In short:**  
- I turn ideas into working products quickly (36-hour hackathon wins)  
- I make things **20-40% better** (efficiency, accuracy, usability)  
- I write **reliable, well-tested code** (98% coverage, production-ready)  
- I'm **versatile**: AI/ML + full-stack + IT support  
- I lead teams, mentor others, and thrive in fast-moving environments  

**Bottom line:**  
You get a **dependable, quick-learning contributor** who cares about quality and impact — ready to add value from day one.
